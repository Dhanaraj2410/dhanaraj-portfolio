...
const ROLE_RESUMES = {
  "data-analyst": {
    ...
    adminResumeUrl: null // Set dynamically if admin uploads a file in Django
  },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderRoleCard(roleKey) {
    ...
    // Determine download action: Admin Uploaded Resume vs Fallback Default Resume
    ...
    roleDisplayContainer.innerHTML = `
      <div class="resume-role-card reveal visible">
        ...
        <div class="resume-role-card__body">
          ...
          <!-- 2026 Fresher Verification Banner -->
  ...
  window.downloadRoleResume = function(roleKey) {
    ...
    // If Admin uploaded file exists, download that file
    ...
    // Default created resume printable/blob fallback
